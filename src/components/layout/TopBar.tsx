...
export function TopBar() {
  ...
  return (
    ...
    >
      ...
      <button onClick={() => setCommandPaletteOpen(true)} className="touch-target text-airis-text-muted hover:text-airis-text" aria-label="Command Palette" title="Quick Open (Ctrl+P)">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 9L15 15"/><path d="M15 9L9 15"/></svg>
      </button>
