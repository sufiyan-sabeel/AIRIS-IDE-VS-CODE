...
export default function OfflinePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-airis-black text-airis-text p-8 text-center">
      <div className="w-16 h-16 rounded-2xl bg-airis-accent flex items-center justify-center mb-6">
      ...
      <button
        ...
        className="px-6 py-3 bg-airis-accent text-white rounded-xl text-sm font-medium active:bg-airis-accent-hover"
      >
        Retry
      </button>
    </div>
